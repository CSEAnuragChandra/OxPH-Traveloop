    ...
    <main className="min-h-screen bg-gray-50 pb-24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-extrabold text-gray-900">Packing List</h1>
          <p className="text-gray-500 mt-1.5">Get ready for {trip?.title} and don't forget the essentials.</p>
        </div>
